...
export default function OurStory() {
  ...
  return <>
      <div className='flex flex-col justify-center items-center px-10 py-8 md:py-24 max-w-4xl mx-auto '>
        <h1 className='text-2xl md:text-4xl text-blue-900 font-extrabold mb-5 '>Our Story</h1>
        ...
        <p className='md:text-xl text-gray-600 '>Today, we're proud to serve real estate professionals across the nation, helping them grow their businesses one quality lead at a time. Our commitment to excellence and results-driven approach has made us a trusted name in the industry.</p>
      </div>
    </>
}