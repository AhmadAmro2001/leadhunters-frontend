...
export default function OfferFirstSection() {
  ...
  return <>
      <div
        ...
        style={{
          backgroundImage: `url("https://res.cloudinary.com/du4n45qq0/image/upload/v1769141776/cytonn-photography-n95VMLxqM2I-unsplash_sn4der.jpg")`,
        }}
      >
        ...
        <div className="relative z-10 p-10 text-white text-left  md:max-w-4xl ">
          <h1 className="text-3xl md:text-7xl font-semibold mb-2">Transparent Pricing</h1>
